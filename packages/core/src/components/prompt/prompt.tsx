...
type PromptOverlayProps = React.ComponentPropsWithRef<typeof AlertDialogPrimitives.Overlay>;

const PromptOverlay = ({ className, children, ...props }: PromptOverlayProps) => {
...
type PromptContentProps = React.ComponentPropsWithRef<typeof AlertDialogPrimitives.Content> & {
...
type PromptTitleProps = React.ComponentPropsWithRef<typeof AlertDialogPrimitives.Title>;
...
type PromptDescriptionProps = React.ComponentPropsWithRef<typeof AlertDialogPrimitives.Description>;

const PromptDescription = ({ className, children, ...props }: PromptDescriptionProps) => {
  return (
    <AlertDialogPrimitives.Description className={cn("text-sub text-sm", className)} {...props}>
      {children}
    </AlertDialogPrimitives.Description>
  );
};

type PromptTriggerProps = React.ComponentPropsWithRef<typeof AlertDialogPrimitives.Trigger>;
